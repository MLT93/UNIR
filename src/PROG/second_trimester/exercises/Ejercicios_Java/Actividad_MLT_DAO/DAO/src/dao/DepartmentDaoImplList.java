...
public class DepartmentDaoImplList implements IDepartmentDao{
	...
	private void cargarDatos() {
		lista.add(new Department(10, "Financiero", null, 100, iLocationDao.findById(1500)));
		lista.add(new Department(20, "Ventas", null, 201, iLocationDao.findById(1600)));
		lista.add(new Department(30, "Informática", null, 114, iLocationDao.findById(1700)));
