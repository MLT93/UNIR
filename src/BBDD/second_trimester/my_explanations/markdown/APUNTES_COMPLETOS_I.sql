...
/* CREAMOS UNA TABLA, DEFINIENDO LOS CAMPOS, 
TIPOS DE DATOS Y PROPIEDADES */ # COMENTARIO MULTILINEA

CREATE TABLE IF NOT EXISTS PELICULAS(
	COD INT PRIMARY KEY auto_increment,
    TITULO VARCHAR(100) NOT NULL,
    DIRECTOR VARCHAR(80) NOT NULL, # COMENTARIO LINEA
...
INT - INTEGER: 
Número entero entre -2147483648 y 2147483647 
o entre 0 y 4294967295.

DECIMAL - NUMERIC: Almacena los números con coma 
flotante como cadenas o string.

FLOAT(4,2): Almacena números con coma flotante, primer número de parametro digitos parte entera,
segundo número de parametro digitos decimales.

DOUBLE PRECISION - DOUBLE: Almacena número con coma 
